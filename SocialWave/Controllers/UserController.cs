...
namespace SocialWave.Controllers
{
    ...
    public class UserController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> AddPictureProfile(IFormFile ImageFile)
        {
            try
            {
                // Валидация файла
                ...
                {
                    ModelState.AddModelError("", "Only image files (JPG, PNG, GIF) are allowed.");
                    return View();
                }
                ...
                using (var memoryStream = new MemoryStream())
                {
                    ...
                    await _profilePictureService.AddPictureProfileAsync(imageBytes, currentUser);
                }
